            ...
            <div>
                <section className="features-sc">
                    <div className="container">
                        <div className="row">
                            <h1 className="section-header" data-aos="fade-down" data-aos-duration="1000"> <span className="text-52">Our Latest </span> <br/>
                                Creations </h1>
                            {services.map((item, i) => {
                                ...
                                <div key={i} className="sevr-section" data-aos="fade-down"  data-aos-duration="1000">
                                    <div className="pic-box"> 
                                        <img src={item['_embedded']['wp:featuredmedia'][0]['source_url'].toString()} className="img-responsive"/> 
                                    </div>
                                    ...
                                    <div className={'sales-count-image '+direction}> 
                                        <img src={'/assets/images/'+cornerimg} alt="Image"/> 
                                    </div>
                                </div>
                                );
                            })}

  ...
  return (
    <div>
        <section className="features">
                    ...
                    return (
                        <div key={i} className="col-lg-3 col-sm-6 col-12" data-aos={'fade-'+direction} data-aos-duration="1000">
                            ...
                            <div className="de_ct-center">
                                <div className="icon-55"><img src={item['icon_image']}/></div>
            ...
            <div className="feature-art-image feature-art-image-left-art"> <img src="assets/images/jt-pointer.png" alt="Image"/> </div>
            </section>
    </div>
  )
}

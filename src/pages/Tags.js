...
export default function Tags() {
  ...
  if (error) {
    ...
    var acfDataStatic = {acf:{page_title:'Tag: '+makeTitle(slug),page_subtitle:'What and how we do about our services.',banner_image:'../../assets/images/inner-banner.jpg'}};
                ...
                <div className="col-sm-12 col-md-8 col-lg-8 mb-4">
                  <div className="left-jk">
                    {acfData.map((item,i) => {
                        ...
                        // console.log(item);
                        if(undefined === item.tags_names.find(c => c.slug === slug))return true;

...
export default function Blog() {
  ...
  if (error) {
    ...
    // console.log(acfData);
    var acfDataStatic = {acf:{page_title:'Our Blog',page_subtitle:'What and how we do about our services.',banner_image:'../assets/images/inner-banner.jpg'}};
                      ...
                      return (
                        <div key={i} className="blog-ct-contain">
                          ...
                          <div className="reading-box">
                            <a href={item.slug} className="reading-55">Continue Reading</a>
                            <p>
